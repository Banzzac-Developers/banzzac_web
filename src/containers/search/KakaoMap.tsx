...
import pepe from "@assets/images/pepe_11.jpg"
...
export default function KakaoMap(){
    ...
    const {data:datas}=useSearchMember(locations); 
    ...
    useEffect(()=>{
      if(datas != null){
        ...
        datas.forEach(data => {
          //커스텀 오버레이 모습 (
          let content = `<img stlye="position:absolute;z-index:5;" src=${pepe} alt="" />`

          //커스텀 오버레이 위치
          var position = new window.kakao.maps.LatLng(data.longitude, data.latitude);  
